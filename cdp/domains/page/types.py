...
class AdFrameStatus:
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                'ad_frame_type': self.ad_frame_type.to_dict(
                    casing_strategy
                ),
        ...
        if casing_strategy == 'snake':
            return {
                'adFrameType': self.ad_frame_type.to_dict(
                    casing_strategy
                ),
                'explanations': _.to_dict(
                    casing_strategy
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'block_reason': self.block_reason.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
            return {
                ...
                'blockReason': self.block_reason.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'usage_restriction': self.usage_restriction.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
            return {
                ...
                'usageRestriction': self.usage_restriction.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'secure_context_type': self.secure_context_type.to_dict(
                    casing_strategy
                ),
                'cross_origin_isolated_context_type': self.cross_origin_isolated_context_type.to_dict(
                    casing_strategy
                ),
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'secureContextType': self.secure_context_type.to_dict(
                    casing_strategy
                ),
                'crossOriginIsolatedContextType': self.cross_origin_isolated_context_type.to_dict(
                    casing_strategy
                ),
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'title': self.title,
                'transition_type': self.transition_type.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
            return {
                ...
                'title': self.title,
                'transitionType': self.transition_type.to_dict(
                    casing_strategy
                ),
            }
        if casing_strategy == 'snake':
