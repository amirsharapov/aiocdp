...
class InlineTextBox:
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                'bounding_box': self.bounding_box.to_dict(casing_strategy),
                'start_character_index': self.start_character_index,
                'num_characters': self.num_characters,
            }        
        if casing_strategy == 'camel':
            return {
                'boundingBox': self.bounding_box.to_dict(casing_strategy),
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'system_id': self.system_id,
                'frame_id': self.frame_id,
                'nodes': self.nodes.to_dict(casing_strategy),
                'layout': self.layout.to_dict(casing_strategy),
                'text_boxes': self.text_boxes.to_dict(casing_strategy),
                'scroll_offset_x': self.scroll_offset_x,
                'scroll_offset_y': self.scroll_offset_y,
        ...
        if casing_strategy == 'camel':
            return {
                ...
                'nodes': self.nodes.to_dict(casing_strategy),
                'layout': self.layout.to_dict(casing_strategy),
                'textBoxes': self.text_boxes.to_dict(casing_strategy),
                'scrollOffsetX': self.scroll_offset_x,
                'scrollOffsetY': self.scroll_offset_y,
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'node_type': self.node_type,
                'shadow_root_type': self.shadow_root_type.to_dict(casing_strategy),
                'node_name': [
                    _.to_dict(casing_strategy)
                ...
                'text_value': self.text_value.to_dict(casing_strategy),
                'input_value': self.input_value.to_dict(casing_strategy),
                'input_checked': self.input_checked.to_dict(casing_strategy),
                'option_selected': self.option_selected.to_dict(casing_strategy),
                'content_document_index': self.content_document_index.to_dict(casing_strategy),
                'pseudo_type': self.pseudo_type.to_dict(casing_strategy),
                'pseudo_identifier': self.pseudo_identifier.to_dict(casing_strategy),
                'is_clickable': self.is_clickable.to_dict(casing_strategy),
                'current_source_url': self.current_source_url.to_dict(casing_strategy),
                'origin_url': self.origin_url.to_dict(casing_strategy),
            }        
        if casing_strategy == 'camel':
            return {
                'parentIndex': self.parent_index,
                'nodeType': self.node_type,
                'shadowRootType': self.shadow_root_type.to_dict(casing_strategy),
                'nodeName': [
                    _.to_dict(casing_strategy)
                    for _ in self.node_name
                ],
                ...
                'textValue': self.text_value.to_dict(casing_strategy),
                'inputValue': self.input_value.to_dict(casing_strategy),
                'inputChecked': self.input_checked.to_dict(casing_strategy),
                'optionSelected': self.option_selected.to_dict(casing_strategy),
                'contentDocumentIndex': self.content_document_index.to_dict(casing_strategy),
                'pseudoType': self.pseudo_type.to_dict(casing_strategy),
                'pseudoIdentifier': self.pseudo_identifier.to_dict(casing_strategy),
                'isClickable': self.is_clickable.to_dict(casing_strategy),
                'currentSourceURL': self.current_source_url.to_dict(casing_strategy),
                'originURL': self.origin_url.to_dict(casing_strategy),
            }        
        if casing_strategy == 'pascal':
            return {
                'ParentIndex': self.parent_index,
    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'stacking_contexts': self.stacking_contexts.to_dict(casing_strategy),
        ...
        if casing_strategy == 'camel':
            return {
                ...
                'stackingContexts': self.stacking_contexts.to_dict(casing_strategy),
