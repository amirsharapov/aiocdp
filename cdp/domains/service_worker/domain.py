...
class ServiceWorker(BaseDomain):
    ...
    def dispatch_periodic_sync_event(
        ...
        registration_id: RegistrationID,
        tag: str
    ) -> 'DispatchPeriodicSyncEventReturnT':
        params = {
            'origin': origin,
            'registrationId': registration_id,
            'tag': tag,
    ...
    ) -> 'SetForceUpdateOnPageLoadReturnT':
        params = {
