    ...
    def to_dict(
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'color_format': self.color_format.to_dict(
                    casing_strategy
                ),
                ...
                'contrast_algorithm': self.contrast_algorithm.to_dict(
                    casing_strategy
                ),
        ...
        if casing_strategy == 'snake':
            return {
                ...
                'colorFormat': self.color_format.to_dict(
                    casing_strategy
                ),
                ...
                'contrastAlgorithm': self.contrast_algorithm.to_dict(
                    casing_strategy
                ),
