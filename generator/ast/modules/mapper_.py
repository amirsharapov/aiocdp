...
def _generate_return_type_from_dict_mapper_body(
    ...
    for return_property in command.returns:
        ...
        if casing_strategy == 'snake':
            key = return_property.name_.snake_case

        if casing_strategy == 'camel':
            key = return_property.name_.camel_case

        if casing_strategy == 'pascal':
            key = return_property.name_.pascal_case
                ...
                value = ast.ListComp(
                    elt=ast.Call(
                        ...
                        args=[
                            ast.Name(
                                f'{command.actual_domain.domain_snake_case_collision_safe}.'
                                f'{return_property.items.ref.actual_type.id_.pascal_case}'
                            ),
                            ast.Name('item'),
            ...
            if return_property.ref.actual_type.properties:
                value = ast.Call(
                    ...
                    args=[
                        ast.Name((
                            f'{command.actual_domain.domain_snake_case_collision_safe}.'
                            f'{return_property.ref.actual_type.id_.pascal_case}'
                        )),
                        key_access,
                        ast.Name('casing_strategy')
                    ],
        ...
        keyword = ast.keyword(
            arg=return_property.name_.snake_case,
            value=value
        )
...
def _generate_type_specific_from_dict_mapper_body(
    ...
    for property_ in type_.properties:
        ...
        if casing_strategy == 'snake':
            key = property_.name_.snake_case

        if casing_strategy == 'camel':
            key = property_.name_.camel_case

        if casing_strategy == 'pascal':
            key = property_.name_.pascal_case
                    ...
                    elt=ast.Call(
                        ...
                        args=[
                            ast.Name((
                                ...
                                f'{property_.items.ref.actual_type.id_.pascal_case}'
                            )),
                            ast.Name('item'),
                            ast.Name('casing_strategy')
                        ]
            ...
            if property_.ref.actual_type.properties:
                value = ast.Call(
                    ...
                    args=[
                        ast.Name((
                            f'{property_.parent.actual_domain.domain_snake_case_collision_safe}.'
                            f'{property_.ref.actual_type.id_.pascal_case}'
                        )),
                        key_access,
                        ast.Name('casing_strategy')
                    ],
        ...
        keyword = ast.keyword(
            arg=property_.name_.snake_case,
            value=value
        )
    ...
    for protocol in protocols:
        for domain in protocol.domains:
            for type_ in domain.types:
                ...
                function = ast.FunctionDef(
                    name=f'_{domain.domain_snake_case}__{type_.id_.snake_case}__from_dict',
                    args=ast.arguments(
                        args=[
                            ast.arg(
                                arg='data',
    ...
    for protocol in protocols:
        for domain in protocol.domains:
            for type_ in domain.types:
                ...
                function = ast.FunctionDef(
                    name=f'_{domain.domain_snake_case}__{type_.id_.snake_case}__to_dict',
                    args=ast.arguments(
                        args=[
                            ast.arg(
                                arg='data',
        ...
        for domain in protocol.domains:
            for type_ in domain.types:
                ...
                lookup.values.append(
                    ast.Name((
                        f'_{domain.domain_snake_case}__{type_.id_.snake_case}__to_dict'
                    ))
                )
    ...
    for protocol in protocols:
        for domain in protocol.domains:
            ...
            for type_ in domain.types:
                ...
                lookup.values.append(
                    ast.Name((
                        f'_{domain.domain_snake_case}__{type_.id_.snake_case}__from_dict'
                    ))
                )
